...
const NavPages = (props) => {
    ...
    return(
        ...
        <CssBaseline />
        <Top/>
        <NavBav token={props.token} profile={props.profile} setProfile={props.setProfile} setToken={props.setToken} setHeight={setHeight} height={height}/>
        ...
        <Routes>
            ...
            <Route path="profile" element={props.token.trim() !== "" ? <Profile  profile={props.profile} height={height}/> : <NoPage/> }/>
